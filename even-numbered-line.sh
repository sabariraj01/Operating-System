# 4. Write a shell script that, given a file name as the argument, will write the even-numbered line to a file with the name evenfile and odd-numbered lines to a file called oddfile.
